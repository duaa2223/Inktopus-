...
//         <div className="mb-8">
//           <label htmlFor="specialization" className="block text-[#8D493A] font-bold mb-2">
...
//             className="w-full bg-[#DFD3C3] border-2 border-[#D0B8A8] rounded-full py-2 px-4 text-[#8D493A] focus:outline-none focus:ring focus:ring-[#D0B8A8] focus:ring-opacity-50 transition-colors duration-300"
//           >
...
//                 <div className="flex justify-between items-center mt-4">
//                   <span className="text-2xl font-bold text-[#8D493A]">${content.price}</span>
//                   {/* <p className="text-[#8D493A] mb-2">Specialization: {content.specialization?.name || 'N/A'}</p> */}
