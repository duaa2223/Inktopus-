...
//     { id: 1, title: 'الكتاب الأول', author: 'المؤلف الأول', status: 'مقروء' },
//     { id: 2, title: 'الكتاب الثاني', author: 'المؤلف الثاني', status: 'يخطط للقراءة' },
//   ]);
...
//   // حفظ التعديل
//   const saveEdit = () => {
//     setBooks(books.map((book) => (book.id === editBookId ? newBook : book)));
//     setNewBook({ title: '', author: '', status: 'مقروء' });
//     setEditBookId(null);
//   };
