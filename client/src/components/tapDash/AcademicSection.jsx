...
const AcademicSection = () => {
  ...
  //     setAcademicYears(prevYears => ({
  //       ...prevYears,
  //       [collegeId]: Array.isArray(data) ? data : []
  //     }));
  //     setError(prev => ({ ...prev, years: null }));
  //   } catch (error) {
  //     console.error('Error fetching academic years:', error);
  //     setError(prev => ({ ...prev, years: error.message }));
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-semibold text-[#8D493A] mb-6">إدارة الأقسام الأكاديمية</h2>
