...
//   // تصفية النتائج بناءً على النوع والبحث
...
//       confirmButtonColor: '#8D493A', // لون متناسق مع الصفحة
//       cancelButtonColor: '#CCAB9A', // لون الزر الإلغاء
...
//                     className="px-4 py-2 rounded-lg bg-red-500 text-white hover:bg-red-700 transition-colors"
//                   >
//                     Delete
//                   </button>
//                 </td>
...
//             className={`px-3 py-1 rounded-lg ${currentPage === index + 1 ? "bg-[#72392C] text-white" : "bg-gray-200 text-gray-700"} transition-colors`}
//           >
//             {index + 1}
//           </button>
//         ))}
